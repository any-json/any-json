...
detect.ini=function(text) { return /^\[.+?\]\s?$/m.test(text); }; // use regex because ini can parse anything
detect.yaml=function(text) { return false; }; // unreliable, disable for now
